import { TouristInsuranceCardData } from "../components/RecomendedProductCard";

export const mockCards: TouristInsuranceCardData[] = [
  {
    imageUrl: "https://kapitalsugurta.uz/uploads/insurance-products/banner-8.jpg", // море
    title: "Страхование туристов",
    subtitle: "Личное страхование",
    description: "Защитите себя в любой поездке. Покрытие по всему миру.",
  ...
  },
  {
    ...
    subtitle: "Личное страхование",
    description: "Финансовая защита при травмах и других рисках.",
    leftButton: "Оформить полис",
    rightButton: "Подробнее",
    iconUserUrl: "/icons/user.outline.svg",
    iconTypeUrl: "/recomended/recomended.svg",
  ...
  },
  {
    ...
    subtitle: "Личное страхование",
    description: "Покрытие травм и рисков при активных занятиях спортом.",
    leftButton: "Оформить полис",
    rightButton: "Подробнее",
    iconUserUrl: "/icons/user.outline.svg",
    iconTypeUrl: "/recomended/recomended.svg",
